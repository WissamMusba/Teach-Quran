...
- **Source:** `icon.png` in this folder (512×512, exported from the app's launcher icon —
  regenerate from `android/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png` if the icon changes)
