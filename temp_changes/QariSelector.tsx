 ...
 *       3) currentQari === item.name renders the ✓ checkmark; 4) Modal onRequestClose -> onClose (Android hardware back).
 * PROPS: visible — modal visibility; onClose — dismiss callback (✕ button and Android back button).
 ...
 *        FIX (Android back): the Modal had no onRequestClose, so the hardware back button was trapped —
 *        the modal could only be dismissed via ✕. Now wired to onClose.
 */
