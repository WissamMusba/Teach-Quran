...
export const quranSlice = createSlice({
  name: 'quran', 
  initialState: { currentSurahId: 1, verses: [] as any[], showTranslation: false, fontSize: 'medium' as 'small' | 'medium' | 'large' | 'xl', readingMode: 'continuous' as 'continuous' | 'page' | 'ayah', surahNames: {} as any, flashingVerse: null as number | null, lastReadSurah: 1, lastReadVerse: 1 },
  reducers: {
...
export const { setSurah, toggleTranslation, setFontSize, setReadingMode, setSurahNames, setFlashingVerse, setLastRead } = quranSlice.actions;
