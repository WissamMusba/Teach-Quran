 ...
 * USED BY: src/components/quran/MushafPageView.tsx:174 (inside overlayLayer — rendered on EVERY page, both normal and fallback paths)
 */
 ...
 * accepted but ignored (declared in the props interface above): dead surface area.
 * FLOW: 1) Absolute-fill wrapper with pointerEvents="none" (taps pass through to the mushaf). 2) Three nested border Views
 *        (borderWidth 1.5/0.8/0.5, borderRadius 20/16/12, offsets 5/12/18). 3) Four corner SVGs (arc + diamond paths + two
 *        dots each, fixed 44x44 viewBox). 4) Top/bottom center SVGs (diamond + side lines, 36x24 viewBox).
 * CALLS: none — pure presentational.
 * CALLED BY: MushafPageView.tsx:174 (overlay layer of every page).
 ...
 *        absolutely positioned — fragile to redesign but cheap.
 */
