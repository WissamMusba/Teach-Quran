...
Explore and search the codebase using standard project tools (grep, ripgrep, file viewing, and symbol search) or MCP tools as appropriate. Inspect files directly to understand implementation details, patterns, and state flow before making changes.
